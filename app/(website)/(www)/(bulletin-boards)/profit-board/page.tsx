    ...
    <div className="w-full h-full">
      ...
      {hasNoPosts ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h3 className="text-xl font-medium mb-2">No profit posts yet</h3>
          <p className="text-muted-foreground mb-6 max-w-md">
            Be the first to share your profit-related content with the
            community.
          </p>
          {session ? (
            <Button size="lg" asChild>
              <Link href="/profit-board/create-post">
