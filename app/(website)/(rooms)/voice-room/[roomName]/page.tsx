...
export default async function Page({ params, searchParams }: Props) {
  try {
    ...
    // Verify this is a voice room
    if (room.room_category !== "voice") {
      console.error("Not a voice room, redirecting to regular room");
      return redirect(`/rooms/${roomName}`);
    }

    console.log("Voice room found:", room.id, room.room_name);

    return <VoiceRoomPage roomData={room} />;
  } catch (error) {
